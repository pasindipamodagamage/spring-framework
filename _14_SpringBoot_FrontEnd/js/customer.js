        ...
        $('#customer_table_body').append(`
                 <tr>
                    ...
                    <td>${customer.address}</td>
                     ...
                     <td>
                          <button class="btn btn-update btn-sm" onclick="editCustomer('${customer.id}','${customer.name}','${customer.address}',${customer.age})">
                           Update
                           </button>
                      </td>
                       <td>
                            <button class="btn btn-delete btn-sm" onclick="deleteCustomer('${customer.id}')">
                              Dalete
                             </button>
                        </td>
                     </tr>
